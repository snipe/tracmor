	...
	class AdminIndexForm extends QForm {
		...
		protected function flaCompanyLogo_Create() {
			...
			if (!QApplication::$TracmorSettings->CompanyLogo) {
				...
				if (AWS_S3) {
					$this->flaCompanyLogo->imgFileIcon->ImagePath = 'http://s3.amazonaws.com/' . AWS_BUCKET . AWS_PATH . '/images/' . QApplication::$TracmorSettings->CompanyLogo;
				} else {
		...
		protected function chkPortablePinRequired_Create() {
			...
			$this->chkPortablePinRequired->Name = 'Portable Pin Required';
